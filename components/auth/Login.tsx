        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <div className="space-y-6">
            <button
              ...
              disabled={isLoading}
              className="flex w-full justify-center items-center rounded-full border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 disabled:opacity-70 disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <p className="text-center text-sm text-gray-600">
                By continuing, you agree to Pinspiration's{' '}
